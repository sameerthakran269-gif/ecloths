      ...
      <div className="max-w-md w-full space-y-8 bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="text-center">
          <Link href="/" className="inline-block">
            <h1 className="text-3xl font-serif font-bold text-rose-600 mb-2">
              EthnicElegance
            </h1>
          </Link>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-colors duration-200"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-colors duration-200"
        ...
        <div className="mt-8 p-4 bg-rose-50 rounded-lg">
          <h3 className="text-sm font-semibold text-rose-900 mb-2">Benefits of joining:</h3>
